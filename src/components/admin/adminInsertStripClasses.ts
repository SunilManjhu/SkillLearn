...
export const ADMIN_INSERT_STRIP_OUTER_EXPAND_HOVER =
  'max-md:overflow-visible max-md:py-0.5 md:overflow-hidden md:py-0 md:transition-[max-height] md:duration-200 md:ease-out md:delay-0 md:max-h-3 md:hover:max-h-[4.25rem] md:hover:delay-[250ms] md:focus-within:max-h-[4.25rem] md:focus-within:delay-[250ms]';
...
export const ADMIN_INSERT_STRIP_CHIP_BTN_PERSIST_PAIR =
  'flex min-h-11 min-w-0 w-full max-w-full flex-1 touch-manipulation items-center justify-center gap-1.5 rounded-md border border-dashed border-[var(--border-color)]/50 bg-[var(--bg-secondary)]/25 px-2 py-1.5 text-[10px] font-semibold leading-tight text-[var(--text-muted)] opacity-90 transition-[background-color,border-color,color,opacity] duration-150 ease-out hover:border-orange-500/50 hover:bg-orange-500/15 hover:text-orange-600 hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/40 dark:hover:bg-orange-500/20 dark:hover:text-orange-300 sm:px-3 sm:text-[11px] sm:leading-snug';
